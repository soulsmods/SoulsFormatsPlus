...
namespace SoulsFormats
{
    public partial class FLVER2
    {
        ...
        public class VertexBuffer
        {
            ...
            internal void ReadBuffer(BinaryReaderEx br, List<BufferLayout> layouts, List<FLVER.Vertex> vertices, int dataOffset, FLVER2Header header)
            {
            ...
            internal void WriteBuffer(BinaryWriterEx bw, int index, List<BufferLayout> layouts, List<FLVER.Vertex> Vertices, int dataStart, FLVER2Header header)
            {
                BufferLayout layout = layouts[LayoutIndex];
